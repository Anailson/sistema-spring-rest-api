...
public class ControleExcecoes extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler({Exception.class, RuntimeException.class, Throwable.class})//pega todas as msgs que de ERRO   .class
	@Override
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		//MOTANDO A MSG DE ERRO
		if (ex instanceof MethodArgumentNotValidException) { //argumentos invalidos para algum metodo
		...
		//MONTANDO O OBJETO DE ERRO - RETORNO EM JSON
	...
	//ERROS A NIVEL DE BANCO DE DADOS
	...
	protected ResponseEntity<Object>  handleExceptionDataIntegry (Exception ex) {
		...
		//mostra a msg de erro mais visivel
